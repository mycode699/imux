export const testimonials = [
  ...
  },
  {
    ...
    text: "imux 良さそうすぎてついにバイバイ VSCode するときなのかもしれない",
    lang: "ja",
  ...
  },
  {
    ...
    text: "年初にWarpからGhosttyに乗り換えたけど、今はimuxに乗り換えた\uD83D\uDCBB 垂直タブが便利で、Claude Codeのタスクの終了が通知されるのがありがたい。Ghosttyベースだから爆速動作はそのまま。ghosttyでやったブランチ表示や補完もそのまま使える",
    lang: "ja",
