...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const url = locale === "en" ? "/blog/introducing-imux" : `/${locale}/blog/introducing-imux`;
  return {
    title: t("metaTitle"),
    description: t("metaDescription"),
    keywords: [
      "imux", "terminal", "macOS", "Ghostty", "libghostty",
...
export default function IntroducingImuxPage() {
