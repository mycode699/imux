...
- Current public stable line: `v1.5.2`
...
1. Update `MARKETING_VERSION` to the target release, currently `1.5.2`.
...
8. Create and push a tag such as `v1.5.2` after the website-hosted artifacts have been verified.
