# imux terminfo overlay

imux ships Ghostty's `xterm-ghostty` terminfo entry, but the embedded
renderer in imux has differed from Ghostty's app renderer in how it treats
